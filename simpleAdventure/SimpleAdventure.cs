...
namespace SimpleAdventure
{
    public partial class SimpleAdventure : Form
    {
        ...
        public SimpleAdventure()
        {
            ...
            lbExp.Text = _player.ExperiencePoints.ToString();
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            {
                if (newLocation != null && newLocation.ItemRequired != null)
                {
            ...
            if (newLocation.QuestAvailable != null)
            {
                ...
                if (playerAlreadyHasQuest)
                {
                    if (!playerAlreadyCompletedQuest)
                    {
                        ...
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            rtbMessages.Text += "You complete the '" + newLocation.QuestAvailable.Name + "' quest." + Environment.NewLine;
                            ...
                            rtbMessages.Text += newLocation.QuestAvailable.RewardExpPoints.ToString() + " experience points" + Environment.NewLine;
                            rtbMessages.Text += newLocation.QuestAvailable.RewardGold.ToString() + " gold" + Environment.NewLine;
                            if (newLocation.QuestAvailable.ItemReward != null)
                            {
                                rtbMessages.Text += newLocation.QuestAvailable.ItemReward.Name + Environment.NewLine;
                            }
                            rtbMessages.Text += Environment.NewLine;

                            _player.ExperiencePoints += newLocation.QuestAvailable.RewardExpPoints;
                            _player.Gold += newLocation.QuestAvailable.RewardGold;

                            // Add the reward item to the player's inventory
                            if (newLocation.QuestAvailable.ItemReward != null)
                            {
                                _player.AddItemToInventory(newLocation.QuestAvailable.ItemReward);
                            }
                ...
                else
                {
                    ...
                    foreach (QuestCompletionItem qci in newLocation.QuestAvailable.QuestCompletionItems)
                    {
                        ...
                        {
                            rtbMessages.Text += qci.Quantity.ToString() + " " + qci.Details.NameP + Environment.NewLine;
                        }
                    }
                    rtbMessages.Text += Environment.NewLine;
            ...
            if (newLocation.MonsterHere != null)
            {
                ...
                // Make a new monster, using the values from the standard monster in the World.Monsters list
        ...
        private void btnUseWeapon_Click(object sender, EventArgs e)
        {
            ...
            if (_currentMonster.CurrentHitPoints <= 0)
            {
                ...
                _player.ExperiencePoints += _currentMonster.RewardExpPoints;
                ...
                foreach (InventoryItem inventoryItem in lootedItems)
                {
                    ...
                    {
                        rtbMessages.Text += "You loot " + inventoryItem.Quantity.ToString() + " " + inventoryItem.Details.NameP + Environment.NewLine;
                    }
                }
